...
config :remote_backend_exercise, RemoteBackendExerciseWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "hg3kaSEs3RK5or+07+YqGlgp1h7kwSeWFnrHYtAuOqnrx3siaUr9LJq3SZQPUAAU",
  ...
  live_view: [signing_salt: "RWfUBmim"]
...
config :remote_backend_exercise, RemoteBackendExercise.Mailer, adapter: Swoosh.Adapters.Local
